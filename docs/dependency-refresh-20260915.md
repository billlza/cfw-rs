...
The dependency refresh produced 0.4.0 build 40068. Its frozen predecessor 40067 is preserved. The subsequent Tunnel startup correction is allocated as build 40069; installed 40068 and its failed-start evidence remain preserved. The direct IPv6 DNS control is allocated as build 40070, preserving installed 40069. The bounded ARM64 dashboard-startup correction is allocated as build 40071, preserving installed 40070 and its signed evidence. This document records source preparation and local validation; it does not assert publication or new-package runtime acceptance.
