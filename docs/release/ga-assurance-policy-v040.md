...
Build 40058 is the only application identity eligible for signing, notarization,
...
archive must contain the exact same 40058 application tree.

Build 40030 must not be built, signed, submitted to Apple, installed, or used as
a substitute for 40058 evidence. It is recorded as
`retired_unbuilt_policy_superseded`; 40058 is the single `active_ga` build.
...
must not be rebuilt, resumed, promoted, installed, or substituted for 40058.
...
resumed, rebuilt, promoted, installed, or substituted for 40058.
...
resumed, rebuilt, installed, packaged, promoted, or substituted for 40058.
...
resumed, rebuilt, signed again, promoted, installed, or substituted for 40058.
...
40058 evidence. This successor is for changed product bytes, not recovery of
...
relabelled, rebuilt, re-signed, installed, promoted or used as 40058 evidence.
...
rebuilt, re-signed, promoted or used as 40058 evidence. Its completed
...
promoted or used as 40058 evidence.
...
durable cleanup quarantine that startup recovery incorrectly rejected. 40058
...
be used as precedent to retire 40058 for a collector, test, documentation, or
...
- an exact-DMG install and 40048-to-40058 migration on a fixed Apple Silicon
...
`target/candidates/0.4.0/ga/40058/stage-inputs/ga-acceptance/migration-journals`.
...
1. `prepackage` verifies the exact 40058 application, source and CI identity,
...
1. replaces the validation/final pair with one enforced `ga_build=40058`;
2. keeps build 40030 unbuilt; builds 40031/40032/40033/40034/40035 consumed and
   ...
   and review path;
3. performs the existing guarded 40048-to-40058 migration directly;
...
immutable 40058 prepackage, GA-acceptance, and publication stages have each
