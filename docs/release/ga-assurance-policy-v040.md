...
Build 40039 is the only application identity signed, notarized, installed,
accepted, and published for the v0.4.0 GA. The DMG and updater archive will be
two distribution envelopes around the exact same 40039 application tree, not
separate application candidates.

Build 40030 must not be built, signed, submitted to Apple, installed, or used as
a substitute for 40039 evidence. It is recorded as
`retired_unbuilt_policy_superseded`; 40039 is the single `active_ga` build.
...
must not be rebuilt, resumed, promoted, installed, or substituted for 40039.
...
resumed, rebuilt, promoted, installed, or substituted for 40039.
...
resumed, rebuilt, installed, packaged, promoted, or substituted for 40039.
...
resumed, rebuilt, signed again, promoted, installed, or substituted for 40039.
...
- an exact-DMG install and 40019-to-40039 migration on a fixed Apple Silicon
...
`target/candidates/0.4.0/ga/40039/stage-inputs/ga-acceptance/migration-journals`.
...
1. `prepackage` verifies the exact 40039 application, source and CI identity,
...
1. replaces the validation/final pair with one enforced `ga_build=40039`;
2. keeps build 40030 unbuilt; builds 40031/40032/40033/40034/40035 consumed and
   ...
   or notarization; all remain permanently outside every active notarization,
   installation, and review path;
3. performs the existing guarded 40019-to-40039 migration directly;
...
immutable 40039 prepackage, GA-acceptance, and publication stages have each
