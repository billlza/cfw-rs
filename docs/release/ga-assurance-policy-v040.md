...
Build 40072 is the only application identity eligible for signing, notarization,
...
archive must contain the exact same 40072 application tree.

Build 40030 must not be built, signed, submitted to Apple, installed, or used as
a substitute for 40072 evidence. It is recorded as
`retired_unbuilt_policy_superseded`; 40072 is the single `active_ga` build.
...
must not be rebuilt, resumed, promoted, installed, or substituted for 40072.
...
resumed, rebuilt, promoted, installed, or substituted for 40072.
...
resumed, rebuilt, installed, packaged, promoted, or substituted for 40072.
...
resumed, rebuilt, signed again, promoted, installed, or substituted for 40072.
...
40072 evidence. This successor is for changed product bytes, not recovery of
...
relabelled, rebuilt, re-signed, installed, promoted or used as 40072 evidence.
...
rebuilt, re-signed, promoted or used as 40072 evidence. Its completed
...
promoted or used as 40072 evidence.
...
journals and vault state. Its subsequent 40043-to-40044 installation remains
historical evidence; no GA acceptance seal, publication seal or public release
was created for 40043.

Build 40044 completed signing, application and DMG notarization, both package
sets and the 40043-to-40044 installation. Before GA runtime acceptance,
StartMigration exposed a product defect: the handoff child treated the parent
process's normal exit as an unrecoverable identity-query error and closed.
The correction changes the application, so 40044 is recorded as
...
archive was produced, and GA runtime collection did not start. Its completed 40045-to-40046 installation remains historical evidence.

Build 40046 completed notarization, both packages and installation, then
exposed the omitted compiled libbox implementation. Correcting the native
product and profile display required 40047; see
[`ga-build-40046-retirement.md`](ga-build-40046-retirement.md). All original
40046 artifacts and journals remain preserved. 40047 completed application
notarization and installation, then exposed the existing-proxy rejection and
service-registration recovery cycle. Their fixes shipped in 40048; see
[`ga-build-40047-retirement.md`](ga-build-40047-retirement.md). 40048 then
failed runtime activation while waiting for macOS authorization. Its successor
40050 moves authorization before runtime startup and fixes repeated revocation
after quarantine; see [`ga-build-40048-retirement.md`](ga-build-40048-retirement.md).
40050 completed signing, notarization and local installation, then exposed a
durable cleanup quarantine that startup recovery incorrectly rejected. 40062
corrects that product behavior and snapshot encoding; see
[`ga-build-40050-retirement.md`](ga-build-40050-retirement.md).
No public release or GA acceptance completed.

Build 40060 completed signing, notarization and installation. Build 40061
changes product bytes to fix SOCKS handshake cancellation, wildcard UDP relay
compatibility and the upstream UDP association cleanup race. Its predecessor
receipts and installed-profile data remain preserved; see
[`ga-build-40060-retirement.md`](ga-build-40060-retirement.md).

Build 40061 completed signing, notarization and installation. Build 40062
changes actual product inputs for independent local proxy use, online profile
transactions, providers, DNS policy, editable network settings, capacity, HTTP/TLS
and explicit background controls. Its predecessor receipts remain immutable; see
[`ga-build-40061-retirement.md`](ga-build-40061-retirement.md).

Build 40062 completed signing, notarization and installation, then failed
Off-mode latency and independent local proxy startup at native protocol
boundaries. Build 40063 corrects those product defects, exact failed-start
cleanup, local-mode service retirement and editing focus. The frozen 40062
application and all prior receipts remain intact; see
[`ga-build-40062-retirement.md`](ga-build-40062-retirement.md).

Build 40063 completed signing, notarization, installation and real local
proxy use. Repeated lifecycle operations exposed stale supervisor clocks
that could revoke or quarantine a newly bound owner. Build 40064 makes
heartbeat binding, renewal and deadline enforcement atomic in the Authority
core; the five-second timeout and exact cleanup proofs remain required.
Preserve the failed installed state, original receipts and signed bytes; see
[`ga-build-40063-retirement.md`](ga-build-40063-retirement.md).

Build 40064 completed signing, notarization and installation. Local proxy
and pure-TUN TCP/UDP passed with an IPv4 DNS policy for the tested proxy exit.
System-originated VPN stop exposed an Active owner-stop attestation rejection.
40065 accepts that exact authenticated proof into Stopping while retaining
the independent Host Off barrier, and exposes IPv6 DNS separately from
IPv6 Tunnel capture. Its product changes require a successor; see
[`ga-build-40064-retirement.md`](ga-build-40064-retirement.md).

Build 40065 passed installed local, pure-TUN and combined System Proxy TCP/UDP
traffic, DNS-family control, offline latency tests and ordinary stop. A system
VPN disconnect reached native Off, but the application retained the released
owner and rejected reconnect by replaying Stop. Build 40066 consumes the
authenticated global Off result while retaining failed-query and identity
protections. Its changed Host bytes require a successor; see
[`ga-build-40065-retirement.md`](ga-build-40065-retirement.md).

Build 40066 completed signing and notarization but was not installed. Native
stop tests reproduced rejection of an already released owner, including when
the Host had not consumed the final status observation. Build 40067 requires
the exact durable generation cursor and independent global Off before
acknowledging that completed stop. Active-owner authentication and cleanup
remain unchanged; see
[`ga-build-40066-retirement.md`](ga-build-40066-retirement.md).

Build 40067's frozen transaction is preserved. The requested dependency
refresh produced successor 40068; see
[`ga-build-40067-retirement.md`](ga-build-40067-retirement.md).

Build 40068 was installed and reproduced a Tunnel startup ticket expiry before
libbox started. Its installed tree and notarization evidence remain preserved.
The corrected startup/error/retry path changes product bytes and requires
successor 40069; see [`ga-build-40068-retirement.md`](ga-build-40068-retirement.md).

Build 40069 was installed and the user confirmed ordinary networking works.
The direct IPv6 DNS control and manual-preference correction change product
bytes, requiring 40070; see [`ga-build-40069-retirement.md`](ga-build-40069-retirement.md).

Build 40070 was signed, notarized, stapled and installed. A supported M5
MacBook Air then exposed a black, unresponsive dashboard at launch. The
bounded renderer-presentation, OS-query, Keychain and cross-process lock
correction changes Host and UI bytes, requiring 40071; see
[`ga-build-40070-retirement.md`](ga-build-40070-retirement.md).

Build 40071 was signed, notarized, stapled and installed. Paired live probes and
real DNS/SOCKS fixtures demonstrated premature five-second setup cancellation.
The corrected protocol budget changes libbox bytes, requiring 40072; see
[`ga-build-40071-retirement.md`](ga-build-40071-retirement.md). Its original
signed application, notarization receipt and failed network samples remain
immutable; subsequent successful samples do not turn that acceptance into a pass.
...
be used as precedent to retire 40072 for a collector, test, documentation, or
...
- an exact-DMG install and 40071-to-40072 migration on a fixed Apple Silicon
...
`target/candidates/0.4.0/ga/40072/stage-inputs/ga-acceptance/migration-journals`.
...
1. `prepackage` verifies the exact 40072 application, source and CI identity,
...
1. replaces the validation/final pair with one enforced `ga_build=40072`;
2. keeps build 40030 unbuilt; builds 40031/40032/40033/40034/40035 consumed and
   ...
   and review path;
3. performs the existing guarded 40071-to-40072 migration directly;
...
immutable 40072 prepackage, GA-acceptance, and publication stages have each
