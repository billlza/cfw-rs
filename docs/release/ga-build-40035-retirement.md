...
new allocation make build 40036 the only active GA successor. It must start
from one new clean source identity and repeat the complete source, hosted-CI,
build, freeze, signing, notarization, package, installation, runtime, and
publication evidence sequence. No application tree, profile copy, possession
proof, signature, manifest, attempt file, or receipt from build 40035 may be
copied forward as successful evidence.
