...
`target/candidates/0.4.0/ga/40044/stage-inputs/publication-blockers.json`; these counts must be
...
- signed app: `target/candidates/0.4.0/ga/40044/signed/Clash for Mac.app`;
- prepared closure: `target/candidates/0.4.0/ga/40044/stage-inputs/publication-prepared`;
- final evidence: `target/candidates/0.4.0/ga/40044/stage-inputs/publication`.
