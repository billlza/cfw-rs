...
struct ReleaseObservationTests {
  ...
  func fixedPreviewIdentity() throws {
    let candidate = try ReleaseObservationCandidate(version: "0.5.0", buildNumber: "50008")
    #expect(candidate.version == "0.5.0")
    #expect(candidate.buildNumber == "50008")
    for (version, build) in [
      ("0.5.0", "40073"), ("0.5.0", "50001"), ("0.5.0", "50002"), ("0.5.0", "50003"),
      ("0.5.0", "50004"), ("0.5.0", "50005"), ("0.5.0", "50007"), ("0.5.0", "50009"),
      ("0.5.1", "50008"),
      ("0.5.0", "050008"), ("0.5.0", "５０００８"),
    ] {
