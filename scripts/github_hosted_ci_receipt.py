#!/usr/bin/env python3
"""Capture and live-verify the exact hosted GitHub Actions receipt for GA 40060.
...
RECEIPT_RELATIVE: Final = Path(
    "target/candidates/0.4.0/ga/40060/stage-inputs/hosted-ci.json"
)
