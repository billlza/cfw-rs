...
readonly ga_root="$artifact_repository/target/candidates/0.4.0/ga/40046"
...
[[ "$version" == "0.4.0" && "$build_number" == "40046" ]] ||
  die "signed app is not the active GA 0.4.0/40046 identity"
