...
readonly ga_root="$artifact_repository/target/candidates/0.4.0/ga/40069"
...
[[ "$version" == "0.4.0" && "$build_number" == "40069" ]] ||
  die "signed app is not the active GA 0.4.0/40069 identity"
