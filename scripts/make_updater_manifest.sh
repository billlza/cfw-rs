...
readonly ga_root="$artifact_repository/target/candidates/0.4.0/ga/40050"
...
[[ "$version" == "0.4.0" && "$build_number" == "40050" ]] ||
  die "signed app is not the active GA 0.4.0/40050 identity"
