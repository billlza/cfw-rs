...
if sys.argv[2] != SIGNED_PREVIEW_IDENTITY.build_number:
    raise SystemExit("preview build must equal the reviewed 50011 identity")
...
import sys
native = sys.argv[1]
print(json.dumps({"bundle": {"macOS": {"bundleVersion": "50011", "files": {
...
echo "Real 0.5.0/50011 Host prepared and byte-verified: $pre_sign_app"
