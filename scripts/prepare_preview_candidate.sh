...
if sys.argv[2] != SIGNED_PREVIEW_IDENTITY.build_number:
    raise SystemExit("preview build must equal the reviewed 50004 identity")
...
import sys
native = sys.argv[1]
print(json.dumps({"bundle": {"macOS": {"bundleVersion": "50004", "files": {
...
echo "Real 0.5.0/50004 Host prepared and byte-verified: $pre_sign_app"
