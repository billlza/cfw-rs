...
evidence, or success override.  The fixed 40024 validation candidate must be
approved before the fixed 40025 final candidate, and every request field is
...
def self_check(repository: Path) -> None:
    if (PRODUCT_VERSION, VALIDATION_BUILD, FINAL_BUILD) != ("0.4.0", "40024", "40025"):
