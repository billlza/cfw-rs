...
evidence, or success override.  The fixed 40021 validation candidate must be
approved before the fixed 40022 final candidate, and every request field is
...
def self_check(repository: Path) -> None:
    if (PRODUCT_VERSION, VALIDATION_BUILD, FINAL_BUILD) != ("0.4.0", "40021", "40022"):
