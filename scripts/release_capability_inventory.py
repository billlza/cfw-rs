...
LEVEL_REPORT_POLICY: dict[str, tuple[tuple[str, str, str], ...]] = {
    ...
    "Unsigned_CI_Verified": (
        (
            "unsigned-artifact",
            "unsigned_artifact",
            "target/candidates/0.4.0/validation/40021/signed/Clash for Mac.app.manifest.json",
        ),
        (
            "deterministic-ci",
            "deterministic_test",
            "target/candidates/0.4.0/validation/40021/evidence/unsigned-ci-lanes.json",
        ),
    ),
