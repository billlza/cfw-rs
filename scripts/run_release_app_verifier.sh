...
readonly app_path="$repo_root/target/candidates/0.4.0/ga/40053/signed/Clash for Mac.app"
readonly native_products="$repo_root/target/candidates/0.4.0/ga/40053/signing-output/signed-native-products"
exec /bin/bash -p \
