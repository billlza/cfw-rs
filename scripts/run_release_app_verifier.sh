...
readonly app_path="$repo_root/target/candidates/0.4.0/ga/40057/signed/Clash for Mac.app"
readonly native_products="$repo_root/target/candidates/0.4.0/ga/40057/signing-output/signed-native-products"
exec /bin/bash -p \
