...
readonly app_path="$repo_root/target/candidates/0.4.0/ga/40067/signed/Clash for Mac.app"
readonly native_products="$repo_root/target/candidates/0.4.0/ga/40067/signing-output/signed-native-products"
exec /bin/bash -p \
