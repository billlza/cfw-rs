...
fixture_artifact_repository="$fixture_repo/target/release-worktrees/40061"
ga_root="$fixture_artifact_repository/target/candidates/0.4.0/ga/40061"
...
release_native_products_root_for_app() {
  [[ "\$1" == "\$publication_artifact_repository/target/candidates/0.4.0/ga/40061/signed/Clash for Mac.app" ]]
  printf '%s\n' "\$publication_artifact_repository/target/candidates/0.4.0/ga/40061/signing-output/signed-native-products"
}

verify_release_prepackage_evidence() {
  [[ "\$#" -eq 1 && "\$1" == "\$publication_artifact_repository/target/candidates/0.4.0/ga/40061/signed/Clash for Mac.app" ]]
...
[[ "$#" -eq 4 ]]
[[ "$1" == "$repo_root/target/candidates/0.4.0/ga/40061/signed/Clash for Mac.app" ]]
[[ "$2" == "$repo_root/target/candidates/0.4.0/ga/40061/signing-output/signed-native-products" ]]
[[ "$3" == "--context" ]]
...
expected_repository = Path(__file__).resolve().parents[1] / "target/release-worktrees/40061"
