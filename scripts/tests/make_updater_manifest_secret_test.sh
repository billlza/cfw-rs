...
ga_root="$fixture_repo/target/candidates/0.4.0/ga/40038"
...
release_native_products_root_for_app() {
  [[ "\$1" == "\${BASH_SOURCE[0]%/scripts/release_publication_gate.sh}/target/candidates/0.4.0/ga/40038/signed/Clash for Mac.app" ]]
  printf '%s\n' "\${BASH_SOURCE[0]%/scripts/release_publication_gate.sh}/target/candidates/0.4.0/ga/40038/signing-output/signed-native-products"
}

verify_release_prepackage_evidence() {
  [[ "\$#" -eq 1 && "\$1" == "\${BASH_SOURCE[0]%/scripts/release_publication_gate.sh}/target/candidates/0.4.0/ga/40038/signed/Clash for Mac.app" ]]
}
SH
...
[[ "$#" -eq 4 ]]
[[ "$1" == "$repo_root/target/candidates/0.4.0/ga/40038/signed/Clash for Mac.app" ]]
[[ "$2" == "$repo_root/target/candidates/0.4.0/ga/40038/signing-output/signed-native-products" ]]
[[ "$3" == "--context" ]]
