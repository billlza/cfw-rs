...
NEW = AppIdentity("0.4.0", "40040", "b" * 64)
...
class DormantInstallValidationTests(unittest.TestCase):
    ...
    def test_ga_profile_has_one_fixed_40019_to_40040_path_and_journal(self) -> None:
        paths = InstallPaths.production()

        self.assertEqual(paths.profile, GA_INSTALL_PROFILE)
        self.assertEqual(paths.profile.build_number, "40040")
        ...
        self.assertEqual(
            ...
            Path(
                "target/candidates/0.4.0/ga/40040/signing-output/signed-native-products"
            ),
        )
    ...
    def test_production_candidate_is_fixed_to_40040_ga_root(self) -> None:
        paths = InstallPaths.production()
        self.assertTrue(
