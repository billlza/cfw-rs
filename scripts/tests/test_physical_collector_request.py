...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_ga_40044_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be GA release build 40044"),
            ("40003", "must be GA release build 40044"),
            ("40004", "must be GA release build 40044"),
            ("40005", "must be GA release build 40044"),
            ("40019", "must be GA release build 40044"),
            ("40020", "must be GA release build 40044"),
            ("40022", "must be GA release build 40044"),
            ("40023", "must be GA release build 40044"),
            ("40026", "must be GA release build 40044"),
            ("40027", "must be GA release build 40044"),
            ("40028", "must be GA release build 40044"),
            ("40029", "must be GA release build 40044"),
            ("40030", "must be GA release build 40044"),
            ("40031", "must be GA release build 40044"),
            ("40032", "must be GA release build 40044"),
            ("40033", "must be GA release build 40044"),
            ("40034", "must be GA release build 40044"),
            ("40035", "must be GA release build 40044"),
            ("40036", "must be GA release build 40044"),
            ("40037", "must be GA release build 40044"),
            ("40038", "must be GA release build 40044"),
            ("40039", "must be GA release build 40044"),
            ("40040", "must be GA release build 40044"),
            ("40041", "must be GA release build 40044"),
            ("40042", "must be GA release build 40044"),
            ("40043", "must be GA release build 40044"),
