...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_ga_40036_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be GA release build 40036"),
            ("40003", "must be GA release build 40036"),
            ("40004", "must be GA release build 40036"),
            ("40005", "must be GA release build 40036"),
            ("40019", "must be GA release build 40036"),
            ("40020", "must be GA release build 40036"),
            ("40022", "must be GA release build 40036"),
            ("40023", "must be GA release build 40036"),
            ("40026", "must be GA release build 40036"),
            ("40027", "must be GA release build 40036"),
            ("40028", "must be GA release build 40036"),
            ("40029", "must be GA release build 40036"),
            ("40030", "must be GA release build 40036"),
            ("40031", "must be GA release build 40036"),
            ("40032", "must be GA release build 40036"),
            ("40033", "must be GA release build 40036"),
            ("40034", "must be GA release build 40036"),
            ("40035", "must be GA release build 40036"),
