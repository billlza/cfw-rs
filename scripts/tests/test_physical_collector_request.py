...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_ga_40062_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be GA release build 40062"),
            ("40003", "must be GA release build 40062"),
            ("40004", "must be GA release build 40062"),
            ("40005", "must be GA release build 40062"),
            ("40019", "must be GA release build 40062"),
            ("40020", "must be GA release build 40062"),
            ("40022", "must be GA release build 40062"),
            ("40023", "must be GA release build 40062"),
            ("40026", "must be GA release build 40062"),
            ("40027", "must be GA release build 40062"),
            ("40028", "must be GA release build 40062"),
            ("40029", "must be GA release build 40062"),
            ("40030", "must be GA release build 40062"),
            ("40031", "must be GA release build 40062"),
            ("40032", "must be GA release build 40062"),
            ("40033", "must be GA release build 40062"),
            ("40034", "must be GA release build 40062"),
            ("40035", "must be GA release build 40062"),
            ("40036", "must be GA release build 40062"),
            ("40037", "must be GA release build 40062"),
            ("40038", "must be GA release build 40062"),
            ("40039", "must be GA release build 40062"),
            ("40040", "must be GA release build 40062"),
            ("40041", "must be GA release build 40062"),
            ("40042", "must be GA release build 40062"),
            ("40043", "must be GA release build 40062"),
            ("40044", "must be GA release build 40062"),
            ("40045", "must be GA release build 40062"),
