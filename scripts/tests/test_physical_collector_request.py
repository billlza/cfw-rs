...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_ga_40041_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be GA release build 40041"),
            ("40003", "must be GA release build 40041"),
            ("40004", "must be GA release build 40041"),
            ("40005", "must be GA release build 40041"),
            ("40019", "must be GA release build 40041"),
            ("40020", "must be GA release build 40041"),
            ("40022", "must be GA release build 40041"),
            ("40023", "must be GA release build 40041"),
            ("40026", "must be GA release build 40041"),
            ("40027", "must be GA release build 40041"),
            ("40028", "must be GA release build 40041"),
            ("40029", "must be GA release build 40041"),
            ("40030", "must be GA release build 40041"),
            ("40031", "must be GA release build 40041"),
            ("40032", "must be GA release build 40041"),
            ("40033", "must be GA release build 40041"),
            ("40034", "must be GA release build 40041"),
            ("40035", "must be GA release build 40041"),
            ("40036", "must be GA release build 40041"),
            ("40037", "must be GA release build 40041"),
            ("40038", "must be GA release build 40041"),
            ("40039", "must be GA release build 40041"),
            ("40040", "must be GA release build 40041"),
