...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_ga_40042_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be GA release build 40042"),
            ("40003", "must be GA release build 40042"),
            ("40004", "must be GA release build 40042"),
            ("40005", "must be GA release build 40042"),
            ("40019", "must be GA release build 40042"),
            ("40020", "must be GA release build 40042"),
            ("40022", "must be GA release build 40042"),
            ("40023", "must be GA release build 40042"),
            ("40026", "must be GA release build 40042"),
            ("40027", "must be GA release build 40042"),
            ("40028", "must be GA release build 40042"),
            ("40029", "must be GA release build 40042"),
            ("40030", "must be GA release build 40042"),
            ("40031", "must be GA release build 40042"),
            ("40032", "must be GA release build 40042"),
            ("40033", "must be GA release build 40042"),
            ("40034", "must be GA release build 40042"),
            ("40035", "must be GA release build 40042"),
            ("40036", "must be GA release build 40042"),
            ("40037", "must be GA release build 40042"),
            ("40038", "must be GA release build 40042"),
            ("40039", "must be GA release build 40042"),
            ("40040", "must be GA release build 40042"),
            ("40041", "must be GA release build 40042"),
