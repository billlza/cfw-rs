...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_ga_40040_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be GA release build 40040"),
            ("40003", "must be GA release build 40040"),
            ("40004", "must be GA release build 40040"),
            ("40005", "must be GA release build 40040"),
            ("40019", "must be GA release build 40040"),
            ("40020", "must be GA release build 40040"),
            ("40022", "must be GA release build 40040"),
            ("40023", "must be GA release build 40040"),
            ("40026", "must be GA release build 40040"),
            ("40027", "must be GA release build 40040"),
            ("40028", "must be GA release build 40040"),
            ("40029", "must be GA release build 40040"),
            ("40030", "must be GA release build 40040"),
            ("40031", "must be GA release build 40040"),
            ("40032", "must be GA release build 40040"),
            ("40033", "must be GA release build 40040"),
            ("40034", "must be GA release build 40040"),
            ("40035", "must be GA release build 40040"),
            ("40036", "must be GA release build 40040"),
            ("40037", "must be GA release build 40040"),
            ("40038", "must be GA release build 40040"),
