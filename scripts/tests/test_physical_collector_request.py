...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_ga_40039_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be GA release build 40039"),
            ("40003", "must be GA release build 40039"),
            ("40004", "must be GA release build 40039"),
            ("40005", "must be GA release build 40039"),
            ("40019", "must be GA release build 40039"),
            ("40020", "must be GA release build 40039"),
            ("40022", "must be GA release build 40039"),
            ("40023", "must be GA release build 40039"),
            ("40026", "must be GA release build 40039"),
            ("40027", "must be GA release build 40039"),
            ("40028", "must be GA release build 40039"),
            ("40029", "must be GA release build 40039"),
            ("40030", "must be GA release build 40039"),
            ("40031", "must be GA release build 40039"),
            ("40032", "must be GA release build 40039"),
            ("40033", "must be GA release build 40039"),
            ("40034", "must be GA release build 40039"),
            ("40035", "must be GA release build 40039"),
            ("40036", "must be GA release build 40039"),
            ("40037", "must be GA release build 40039"),
            ("40038", "must be GA release build 40039"),
