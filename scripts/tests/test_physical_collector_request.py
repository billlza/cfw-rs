...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_ga_40034_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be GA release build 40034"),
            ("40003", "must be GA release build 40034"),
            ("40004", "must be GA release build 40034"),
            ("40005", "must be GA release build 40034"),
            ("40019", "must be GA release build 40034"),
            ("40020", "must be GA release build 40034"),
            ("40022", "must be GA release build 40034"),
            ("40023", "must be GA release build 40034"),
            ("40026", "must be GA release build 40034"),
            ("40027", "must be GA release build 40034"),
            ("40028", "must be GA release build 40034"),
            ("40029", "must be GA release build 40034"),
            ("40030", "must be GA release build 40034"),
            ("40031", "must be GA release build 40034"),
            ("40032", "must be GA release build 40034"),
            ("40033", "must be GA release build 40034"),
