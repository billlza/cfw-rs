...
class PhysicalCollectorRequestTests(unittest.TestCase):
    ...
    def test_initialize_requires_final_40025_build_with_signed_64_bit_bound(self) -> None:
        for build_number, message in (
            ("40002", "must be final release build 40025"),
            ("40003", "must be final release build 40025"),
            ("40004", "must be final release build 40025"),
            ("40005", "must be final release build 40025"),
            ("40019", "must be final release build 40025"),
            ("40020", "must be final release build 40025"),
            ("40022", "must be final release build 40025"),
            ("40023", "must be final release build 40025"),
            ("40024", "must be final release build 40025"),
