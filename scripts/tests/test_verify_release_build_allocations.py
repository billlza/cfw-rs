...
class ReleaseBuildAllocationTests(unittest.TestCase):
    def test_active_identity_is_the_single_ga_build(self) -> None:
        ...
        self.assertEqual(identity.ga_build, "40031")
        allocations.verify_source_bindings(allocations.load_contract())

    def test_tracked_contract_matches_active_ga_and_retires_40030(self) -> None:
        value = allocations.load_contract()
        allocations.validate_contract(value, expected_ga="40031")
        self.assertEqual(value["active_ga"], "40031")
        self.assertEqual(
            value["allocations"][-2],
            {
                "build": "40030",
    ...
    def test_only_40031_can_be_the_single_active_ga(self) -> None:
        value = copy.deepcopy(allocations.load_contract())
