...
[[ "$build_number" == "40064" ]] ||
  die "release application is not the fixed GA build 40064"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40064/profiles/signing-preflight.json"
