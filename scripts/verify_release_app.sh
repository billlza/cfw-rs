...
[[ "$build_number" == "40067" ]] ||
  die "release application is not the fixed GA build 40067"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40067/profiles/signing-preflight.json"
