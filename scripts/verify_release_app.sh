...
[[ "$build_number" == "40038" ]] ||
  die "release application is not the fixed GA build 40038"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40038/profiles/signing-preflight.json"
