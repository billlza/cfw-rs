...
[[ "$build_number" == "40065" ]] ||
  die "release application is not the fixed GA build 40065"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40065/profiles/signing-preflight.json"
