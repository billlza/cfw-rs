...
[[ "$build_number" == "40041" ]] ||
  die "release application is not the fixed GA build 40041"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40041/profiles/signing-preflight.json"
