...
[[ "$build_number" == "40070" ]] ||
  die "release application is not the fixed GA build 40070"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40070/profiles/signing-preflight.json"
