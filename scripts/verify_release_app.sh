...
[[ "$build_number" == "40046" ]] ||
  die "release application is not the fixed GA build 40046"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40046/profiles/signing-preflight.json"
