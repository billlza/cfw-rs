...
[[ "$build_number" == "40042" ]] ||
  die "release application is not the fixed GA build 40042"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40042/profiles/signing-preflight.json"
