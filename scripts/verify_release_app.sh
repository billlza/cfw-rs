...
[[ "$build_number" == "40036" ]] ||
  die "release application is not the fixed GA build 40036"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40036/profiles/signing-preflight.json"
