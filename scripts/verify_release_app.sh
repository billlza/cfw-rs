...
[[ "$build_number" == "40047" ]] ||
  die "release application is not the fixed GA build 40047"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40047/profiles/signing-preflight.json"
