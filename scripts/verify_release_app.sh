...
[[ "$build_number" == "40054" ]] ||
  die "release application is not the fixed GA build 40054"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40054/profiles/signing-preflight.json"
