...
configure_release_verification_context() {
  ...
  case "$context" in
    ...
    preview-signing-attempt-work|preview-signing-attempt-publish-ready|preview-canonical-native-content)
      ...
      expected_build_number="50014"
      preview_ui=1
      signing_preflight_manifest="$repo_root/target/candidates/0.5.0/preview-preflight/50014/profiles/signing-preflight.json"
      pre_sign_native_products_root="$repo_root/target/candidates/0.5.0/preview-preflight/50014/native-products"
      ;;
