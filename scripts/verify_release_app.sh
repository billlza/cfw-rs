...
[[ "$build_number" == "40055" ]] ||
  die "release application is not the fixed GA build 40055"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40055/profiles/signing-preflight.json"
