...
[[ "$build_number" == "40048" ]] ||
  die "release application is not the fixed GA build 40048"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40048/profiles/signing-preflight.json"
