...
[[ "$build_number" == "40061" ]] ||
  die "release application is not the fixed GA build 40061"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40061/profiles/signing-preflight.json"
