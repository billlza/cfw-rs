...
[[ "$build_number" == "40043" ]] ||
  die "release application is not the fixed GA build 40043"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40043/profiles/signing-preflight.json"
