...
[[ "$build_number" == "40051" ]] ||
  die "release application is not the fixed GA build 40051"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40051/profiles/signing-preflight.json"
