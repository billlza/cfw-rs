...
[[ "$build_number" == "40072" ]] ||
  die "release application is not the fixed GA build 40072"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40072/profiles/signing-preflight.json"
