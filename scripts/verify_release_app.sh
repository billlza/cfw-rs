...
[[ "$build_number" == "40063" ]] ||
  die "release application is not the fixed GA build 40063"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40063/profiles/signing-preflight.json"
