...
[[ "$build_number" == "40059" ]] ||
  die "release application is not the fixed GA build 40059"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40059/profiles/signing-preflight.json"
