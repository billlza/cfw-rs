...
[[ "$build_number" == "40062" ]] ||
  die "release application is not the fixed GA build 40062"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40062/profiles/signing-preflight.json"
