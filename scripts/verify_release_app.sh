...
[[ "$build_number" == "40069" ]] ||
  die "release application is not the fixed GA build 40069"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40069/profiles/signing-preflight.json"
