...
[[ "$build_number" == "40056" ]] ||
  die "release application is not the fixed GA build 40056"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40056/profiles/signing-preflight.json"
