...
[[ "$build_number" == "40068" ]] ||
  die "release application is not the fixed GA build 40068"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40068/profiles/signing-preflight.json"
