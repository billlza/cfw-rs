...
[[ "$build_number" == "40040" ]] ||
  die "release application is not the fixed GA build 40040"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40040/profiles/signing-preflight.json"
