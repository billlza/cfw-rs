...
[[ "$build_number" == "40066" ]] ||
  die "release application is not the fixed GA build 40066"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40066/profiles/signing-preflight.json"
