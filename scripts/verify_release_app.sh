...
[[ "$build_number" == "40057" ]] ||
  die "release application is not the fixed GA build 40057"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40057/profiles/signing-preflight.json"
