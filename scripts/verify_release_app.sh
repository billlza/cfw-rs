...
[[ "$build_number" == "40045" ]] ||
  die "release application is not the fixed GA build 40045"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40045/profiles/signing-preflight.json"
