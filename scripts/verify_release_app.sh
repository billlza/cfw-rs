...
[[ "$build_number" == "40060" ]] ||
  die "release application is not the fixed GA build 40060"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40060/profiles/signing-preflight.json"
