...
[[ "$build_number" == "40037" ]] ||
  die "release application is not the fixed GA build 40037"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40037/profiles/signing-preflight.json"
