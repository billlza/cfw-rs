...
[[ "$build_number" == "40039" ]] ||
  die "release application is not the fixed GA build 40039"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40039/profiles/signing-preflight.json"
