...
[[ "$build_number" == "40058" ]] ||
  die "release application is not the fixed GA build 40058"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40058/profiles/signing-preflight.json"
