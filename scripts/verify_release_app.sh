...
[[ "$build_number" == "40071" ]] ||
  die "release application is not the fixed GA build 40071"
...
signing_preflight_manifest="$repo_root/target/candidates/0.4.0/ga/40071/profiles/signing-preflight.json"
